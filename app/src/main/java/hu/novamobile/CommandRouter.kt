...
object CommandRouter {
    ...
    private val commands: List<Command> = listOf(
        ...
        Command(phrases("ertesitesek", "ertesitesi beallitasok", "jelzesek"), open(Settings.ACTION_NOTIFICATION_SETTINGS, "Megnyitom az értesítési beállításokat.")),
        ...
        Command(phrases("hotspot", "mobil hotspot", "wifi hotspot"), open(Settings.ACTION_TETHER_SETTINGS, "Megnyitom a hotspot beállításait.")),
